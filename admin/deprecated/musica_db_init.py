...
# Interpreter guard
# -------------------------
if not sys.executable.startswith("/opt/Musica/venv"):
    print(
        "\nERROR: This script must be run using the Musica virtual environment.\n"
...
try:
    ...
    print(
        "\nERROR: Required Python module 'mariadb' is not available.\n"
        "Re-run the Musica installer to recreate the virtual environment.\n"
    )
    sys.exit(1)
